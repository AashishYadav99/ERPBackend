...
const store = async (req, res, next) => {
    ...
    try {
        ...
        const filePath = path.join(__dirname, '../../public', 'uploads', 'logos', logoFileName);
        ...
        //     })
        // }
        res.status(200).json(ResponseFormatter.setResponse(true, 200, 'Successfully Add Item', '', company));
    } catch (error) {
        res.status(400).json(ResponseFormatter.setResponse(false, 400, 'Something went wrong!', 'Error', error.message));
    }
}
...
const update = async (req, res, next) => {
    ...
    try {
        ...
        //     })
        // }
        res.status(200).json(ResponseFormatter.setResponse(true, 200, 'Successfully Add company', '', detail));
    } catch (error) {
        res.status(400).json(ResponseFormatter.setResponse(false, 400, 'Something went wrong!', 'Error', error.message));
    }
}
